...
export default function App() {
  ...
  return (
    <div className="app-container" style={{ fontFamily: "'Poppins',sans-serif", background: t.bg, color: t.text, minHeight: "100vh", margin: "0 auto", position: "relative", paddingTop: tgTopOffset, paddingBottom: 90, transition: "background 0.3s, color 0.3s" }}>
      ...
      <header className="app-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "7px 12px", background: t.headerBg, backdropFilter: "blur(20px)", position: "fixed", top: 0, left: 0, width: "100%", zIndex: 1000, borderBottom: `1px solid ${t.cardBorderLight}`, transition: "background 0.3s" }}>
